...
//! | [`ClientConfig`] | Configuration (timeouts, retries, user-agent); deserializes from the `http` YAML section |
//! | [`RequestBuilder`] | Per-request builder with headers, auth, body, and retry overrides |
