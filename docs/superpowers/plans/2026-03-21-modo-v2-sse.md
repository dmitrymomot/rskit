...
- [x] **Step 1: Add `futures-util` as optional dependency and wire feature**
...
- [x] **Step 2: Add feature-gated module in `lib.rs`**
...
- [x] **Step 3: Create empty `src/sse/mod.rs`**
...
- [x] **Step 3: Write `SseConfig` implementation**
...
- [x] **Step 3: Write `Event` implementation**
...
- [x] **Step 3: Add `lagged` field and methods to `Error`**
...
- [x] **Step 5: Run full test suite to ensure nothing broke**
...
- [x] **Step 3: Write `LastEventId` implementation**
...
- [x] **Step 3: Write `BroadcastStream`, `LagPolicy`, and `replay()` implementation**
...
- [x] **Step 3: Write `Broadcaster` implementation**
...
- [x] **Step 4: Update `mod.rs` to re-export `Broadcaster`**
...
- [x] **Step 3: Write `Sender` implementation**
...
- [x] **Step 3: Add `channel()` method to `Broadcaster`**
...
- [x] **Step 5: Run all broadcaster tests**
...
- [x] **Step 3: Write `SseStreamExt` implementation**
...
- [x] **Step 1: Add module-level documentation**
...
- [x] **Step 1: Mark Plan 8 as done in roadmap**
...
- [x] **Step 2: Add SSE-specific gotchas**
...
- [x] **Step 3: Add SSE key references**
